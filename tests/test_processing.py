...
@pytest.mark.parametrize("state_unknown, state, result", [
    ([], None, "отсутствует ключ-значение в словаре")  # ожидаемый ответ
    ,
    ([
        ...
        {"id": 594226727, "state": "CANCELED", "date": "2018-09-12T21:27:25.241689"},  # ожидаемый ответ
        {"id": 615064591, "state": "CANCELED", "date": "2018-10-14T08:21:33.419441"}
    ]),
    ([
        {"id": 41428829, "state": "EXECUTED", "date": "2019-07-03T18:35:29.512364"},
        ...
        {"id": 41428829, "state": "EXECUTED", "date": "2019-07-03T18:35:29.512364"},  # ожидаемый ответ
        {"id": 939719570, "state": "EXECUTED", "date": "2018-06-30T02:08:58.425572"}
    ])
])
...
@pytest.mark.parametrize("false_date, reverse_date, true_date", [
    ([
        ...
        {"id": 939719570, "state": "EXECUTED", "date": "2018-06-30T02:08:58.425572"},  # ожидаемый ответ
        {"id": 41428829, "state": "EXECUTED", "date": "2019-07-03T18:35:29.512364"}
    ]),
    ([
        {"id": 41428829, "state": "EXECUTED", "date": "2019-07-03T18:35:29.512364"},  # ожидаемый ответ
